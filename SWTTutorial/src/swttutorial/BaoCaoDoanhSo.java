...
public class BaoCaoDoanhSo {
	...
	public static void main(String[] args) {
		...
		shell.setText("Phiếu xuất hàng hàng");
		
		Label label1=new Label(shell,SWT.NONE);
		label1.setText("PHIẾU XUẤT HÀNG");
		label1.setBounds(20, 10	,120, 25);
		Label label7=new Label(shell,SWT.NONE);
		label7.setText("Tháng:");
		label7.setBounds(150, 25, 50, 25);
		Text t3=new Text(shell,SWT.BORDER);
		t3.setBounds(200, 20, 50, 25);
		Table table = new Table(shell, SWT.CHECK | SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL);
		table.setHeaderVisible(true);
		String[] titles = { "Tháng", "Đại lý", "Số phiếu xuất", "Tổng giá trị","Tỷ lệ"};
