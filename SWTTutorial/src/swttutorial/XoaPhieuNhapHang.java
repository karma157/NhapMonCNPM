...
public class XoaPhieuNhapHang {
	...
	public static void main(String[] args) {
		...
		shell.setText("Phiếu nhập hàng");
		
		Label label1=new Label(shell,SWT.NONE);
		label1.setText("PHIẾU NHẬP HÀNG");
		label1.setBounds(20, 20	,150, 25);
		Table table = new Table(shell, SWT.CHECK | SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL);
		table.setHeaderVisible(true);
		String[] titles = { "Ngày lập", "Mặt hàng", "ĐVT", "Số lượng", "Đơn giá", "Thành tiền","Tổng tiền","Số tiền trả" ,"Còn lại"};
